...
<body>
        ...
        <div class="content">
          ...
          <div class="content__actions"><a href="video_call.php">
            ...
            <div class="toggle-container">
              <div class="toggle-button <?php echo $active ? 'toggle-on' : 'toggle-off'; ?>"></div>
            </div>
          </div>
  ...
  <script>
    ...
    $(".toggle-container").click(function() {
      ...
      var toggleData = isActive ? 0 : 1 ;
      $.ajax({
        type: "POST",
        url: "../backend/update_active_status.php", // Replace with your backend endpoint
        data: {
          toggle: toggleData
        },
        success: function(response) {
          console.log("Toggle state updated successfully: " + response);
          //reload Page
          location.reload();
