                ...
                <div class="col-xl-3 col-sm-5 col-6">
                    <div class="h3_header-right">
                        ...
                        if (isset($_SESSION['user_id'])) {
                            ...
                            // If the session is started, show the "Profile" button
                            ...
                            // Show different options based on user role in the dropdown
                            echo '        <div class="dropdown-content">';
                            ...
                            echo '<div class="h3_header-btn d-none d-sm-block">';
                            echo '    <a href="sign-in.php" class="header-btn theme-btn theme-btn-medium theme-btn-3">Sign In<i class="fa-light fa-arrow-up-right"></i></a>';
                            echo '</div>';
                        }
                        ?>
